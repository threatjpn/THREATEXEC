...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "BezierSet|RuntimeEdit|Sampling") float UI_FocusGetSampleCountValue();
	...
	UFUNCTION(BlueprintCallable, Category = "BezierSet|RuntimeEdit|Sampling") float UI_FocusGetProofTValue();
	...
	UFUNCTION(BlueprintCallable, Category = "BezierSet|RuntimeEdit|Sampling") ECheckBoxState UI_FocusGetShowSamplePointsCheckState();
	...
	UFUNCTION(BlueprintCallable, Category = "BezierSet|RuntimeEdit|Sampling") ECheckBoxState UI_FocusGetShowDeCasteljauLevelsCheckState();
